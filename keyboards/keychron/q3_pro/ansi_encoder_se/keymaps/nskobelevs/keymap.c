...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_92(
        ...
        _______,  MO(1),    KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,
        _______,  KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,            KC_UP,
        _______,  KC_LCTL,  KC_LOPT,  KC_LCMD,                                KC_SPC,                                 KC_RCMD,  KC_ROPT,  MO(FN1),    KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [FN1] = LAYOUT_ansi_92(
        ...
        BT_HST1,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  _______,  _______,
        BT_HST2,  _______,  _______,  KC_LOPT,  KC_LCMD,  KC_BSPC,   KC_ENT,  KC_LEFT,  KC_DOWN,    KC_UP,  KC_RGHT,  _______,  _______,              _______,
        BT_HST3,  _______,            _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,              _______,            _______,
